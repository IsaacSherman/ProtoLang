...
- That source info is answered, not merely kept. Given a message, enum, field, or enum value
  ...
  once, so a schema restored to those bytes is pointed at again without recompiling. Documentation
