...
| 3 | [#36](https://github.com/IsaacSherman/ProtoLang/issues/36) Bind through parse errors | next |
| 4 | [#39](https://github.com/IsaacSherman/ProtoLang/issues/39) Preserve declaration sites and scope | after #36 |
...
Plan before writing. Where an issue deliberately leaves a decision open, decide it explicitly and ask
